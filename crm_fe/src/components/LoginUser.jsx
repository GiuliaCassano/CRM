...
if(event.target.value.length >= 8  ){    {/** && event.target.value == come devo scriverlo?*/}
  ...
  return (
    <section className="d-flex border border-dark rounded m-3">
      <div className=" col-4 border border-right-dark">
        <form onSubmit={submitHandler} className="d-flex flex-column m-2 p-3">
          {/* CARICAMENTO FOTO PROFILO UTENTE*/}
          <div>
            <label htmlFor="picture">Select your picture</label>
            <button className="btn btn-light m-4">Upload picture</button>
          </div>

          <div>

           <input type="checkbox" id="gdpr" />
            <label htmlFor="agree">Gdpr</label>
          </div>
          <div>
      ...
      <div className="col-8">
        <form onSubmit={submitHandler} className="d-flex flex-column m-2 p-3">
          ...
          <label htmlFor="pswConfirm">Password confirmation</label>
          <input 
          className= {
            checkInputPswConfirm == true
            ? "border border-success border-0 border-bottom"
            : "border border-danger border-0 border-bottom"
          }
